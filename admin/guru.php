...
mata_pelajaran
ON
guru.mata_pelajaran = mata_pelajaran.id_mata_pelajaran
");
?>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg- grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Tabel Guru</h4>
                                    <p class="card-description">
                                        <!-- Add class <code>.table</code> -->
                                    </p>
                                    <a href="tabel/guru/formTambah.php"><button type="button"
                        ...
                        ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d['password'] ?></td>
                                                    <td>
                                                        <a href="tabel/guru/formUpdate.php?id=<?= $d['id_guru'] ?>">
                                                            <button class="btn btn-warning">Update</button></a> |
                                                        <a href="tabel/guru/hapus.php?id=<?= $d['id_guru'] ?>"> <button
