                  ...
                  ?>
                                    <form class="forms-sample" method="post" action="prosesUpdate.php">
                                        <div class="form-group">
                                            <!-- <label for="exampleInputUsername1">Hari</label> -->
                                            <input type="text" class="form-control" value="<?= $d['id_jadwal'] ?>"
                                                hidden name="id_jadwal" placeholder="Hari">
                                        </div>
                        ...
                        while($data = mysqli_fetch_assoc($sql2)){
                          $selected = ($data['id_guru'] == $d['guru']) ? "selected" : "";
                        ?>
                                                <option value="<?= $data['id_guru'] ?>" <?= $selected ?>>
                        ...
                        while($data = mysqli_fetch_assoc($sql2)){
                          $selected = ($data['id_mata_pelajaran'] == $d['id_mata_pelajaran']) ? "selected" : "";
                        ?>
                                        ...
                                        <div cla4ss="form-group">
                                            <label for="">Kelas</label>
                                            <select name="kelas" id="" class="form-control">
                                                <?php 
                         $sql2 = mysqli_query($koneksi , "SELECT * FROM kelas ");
                        while($data = mysqli_fetch_assoc($sql2)){
                          $selected = ($data['id_kelas'] == $d['id_kelas']) ? "selected" : "";
                        ?>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Hari</label>
                                            <input type="text" class="form-control" value="<?= $d['hari'] ?>"
                                                name="hari" placeholder="Hari">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Jam Mulai</label>
                                            <input type="time" class="form-control" name="jamMulai"
                                                value="<?= $d['jam_mulai'] ?>" id="exampleInputEmail1" placeholder="">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Jam Selesai</label>
                                            <input type="time" class="form-control" value="<?= $d['jam_selesai'] ?>"
                                                name="jamSelesai" placeholder="">
                                        </div>
