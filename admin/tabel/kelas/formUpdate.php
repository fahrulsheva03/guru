                  ...
                  ?>
                                    ...
                                    <form class="forms-sample" method="post" action="prosesUpdate.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?= $d['id_kelas'] ?>" hidden
                                                name="id" placeholder="kelas">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nama Kelas</label>
                                            <input type="text" class="form-control" value="<?= $d['nama_kelas'] ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="tingkat"
                                                value="<?= $d['tingkat'] ?>" id="exampleInputEmail1"
                                                placeholder="Tingkat">
                                        </div>
                        ...
                        while($data = mysqli_fetch_assoc($sql2)){
                          $selected = ($data['id_guru'] == $d['id_wali_kelas']) ? "selected" : "";
                        ?>
